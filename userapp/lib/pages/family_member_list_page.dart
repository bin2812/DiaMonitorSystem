...
class _FamilyMemberListPageState extends State<FamilyMemberListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: IAppBar.commonAppBar(title: "Family Members"),
        ...
        if (!_familyMembersController.isError.value&&!_familyMembersController.isError.value) { // if no any error
          if (_familyMembersController.isLoading.value||_familyMembersController.isLoading.value) {
            ...
            return const Padding(
              ...
              child: Text("No family member found. Click the + button at the bottom to add a new one.",
                style: TextStyle(
                    ...
                    children: [
                      familyMembersModel.gender==null||familyMembersModel.gender==""? Container():  Row(
                       ...
                       const    Icon(Icons.person,
                          ...
                          Text(familyMembersModel.gender??"--",
                            style: const TextStyle(
                  ...
                  child: Padding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                            Text("${isForAdding?"Add":"Update"} New Family Member",
                            style:const TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize:15
                            ),),
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text("Are you sure want to delete ${familyMembersModel.fName??""} ${familyMembersModel.lName} from family members list.",
                  textAlign: TextAlign.center,
                  style:const  TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.w400,
