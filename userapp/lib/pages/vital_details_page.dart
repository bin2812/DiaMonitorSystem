...
class _VitalsDetailsPageState extends State<VitalsDetailsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: IBottomNavBarWidget(title: "Family Members",
          onPressed: () {
        ...
        ListView(
          ...
          children: [
            selectedFamilyMemberModel == null ? Container() : Padding(
              ...
              child: Card(
                  ...
                  child: ListTile(
                      ...
                      title: Text(
                    "Name - ${selectedFamilyMemberModel?.fName ??
            ...
            InputDecorator(
              decoration: ThemeHelper().textInputDecoration('Select Vital*'),
                  ...
                  child: Padding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          const Text("Register New Family Member",
                            style: TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize: 15
                            ),),
  ...
  _buildTitleBP(VitalModel vitalModel) {
    return Column(
      ...
      children: [
        Text("BP Systolic - ${vitalModel.bpSystolic.toString()} mmHg",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
        const SizedBox(height: 5),
        Text("BP Diastolic - ${vitalModel.bpDiastolic.toString()} mmHg",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
    ...
    return Column(
      ...
      children: [
        vitalModel.sugarRandom == null ? Container() : Text(
          "Sugar Random - ${vitalModel.sugarRandom.toString()} Mg/dl",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
        ...
        vitalModel.sugarFasting == null ? Container() : Text(
          "Sugar Fasting ${vitalModel.sugarFasting.toString()} Mg/dl",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
  ...
  _buildTitleWeight(VitalModel vitalModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Weight - ${vitalModel.weight.toString()} KG",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
  ...
  _buildTitleTemp(VitalModel vitalModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text("Temp - ${vitalModel.temperature.toString()} F",
          style: const TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
          ),),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InputLabel.buildLabelBox("Date"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Time"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Systolic (mmHg)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                            ...
                            child: TextFormField(
                              ...
                              keyboardType: Platform.isIOS ? const TextInputType
                                  ...
                                  : TextInputType.number,
                              validator: (item) {
                                return item!.isNotEmpty ? null : "Enter value";
                              },
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Diastolic (mmHg)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Weight (KG)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: InputLabel.buildLabelBox("Temp (F)"),
                          ),
                          const SizedBox(height: 10),
                          Container(
                            decoration: ThemeHelper()
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Text("Are you sure want to delete this record",
                  textAlign: TextAlign.center,
