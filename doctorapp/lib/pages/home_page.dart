        ...
        child: ListView(
          ...
          children:  [
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text("${doctorsModel?.averageRating??"0"} (${doctorsModel?.numberOfReview??"0"} review)",
                          style:const TextStyle(
            ...
            Row(
              ...
              children: [
                _buildFeeCard("OPD",doctorsModel?.opdFee.toString()??"0",doctorsModel?.clinicAppointment??0),
                _buildFeeCard("Video",doctorsModel?.videoFee.toString()??"0",doctorsModel?.videoAppointment??0),
                _buildFeeCard("Emergency",doctorsModel?.emgFee.toString()??"0",doctorsModel?.emergencyAppointment??0),
              ],
            ),
            Obx(() {
              if (!dashboardController.isError.value) { // if no any error
                if (dashboardController.isLoading.value) {
                  ...
                  children: [
                    Row(
                      children: [
                        buildCard("Appointment",dashboardModel.totalAppointments?.toString()??"0",ImageConstants.totalAppointmentImage,Colors.green),
                        buildCard("Today",dashboardModel.totalTodayAppointment?.toString()??"0",ImageConstants.todayImage,Colors.orange),
                      ],
                    ),
                    Row(
                      children: [
                        buildCard("Pending",dashboardModel.totalPendingAppointment?.toString()??"0",ImageConstants.pendingImage,Colors.yellow),
                        buildCard("Cancelled",dashboardModel.totalCancelledAppointment?.toString()??"0",ImageConstants.cancelledImage,Colors.redAccent),
                      ],

                    ),
                    Row(
                      children: [
                        buildCard("Confirmed",dashboardModel.totalConfirmedAppointment?.toString()??"0",ImageConstants.confirmedImage,Colors.green),
                        buildCard("Rejected",dashboardModel.totalRejectedAppointment?.toString()??"0",ImageConstants.rejectedImage,Colors.redAccent),
                      ],
            ...
            Card(
              ...
              child: ListTile(
                ...
                title: const Text("Last 20 appointments",
                style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w500
                ),),
                            ...
                            Flexible(
                              child: Column(
                                ...
                                children:  [
                                  ...
                                  Text("Doctor ${appointmentModel.doctFName??"--"} ${appointmentModel.doctLName??"--"}",
                                      style: const TextStyle(
                                        color: ColorResources.secondaryFontColor,
                                        fontWeight: FontWeight.w600,
                                        fontSize: 13,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Fee ${AppConstants.appCurrency}$fee",
                textAlign: TextAlign.center,
                style: const TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.w500
