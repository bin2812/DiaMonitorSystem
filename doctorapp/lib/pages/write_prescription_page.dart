              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Text("Page ${_currentPageIndex + 1} / ${_drawingControllers.length}"),
                    IconButton(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content:  Column(
            ...
            children:  [
              Text("Are you sure want to delete the current page (${_currentPageIndex+1})",
       ...
       builder: (BuildContext context) {
         ...
         return AlertDialog(
           ...
           content:  Column(
             mainAxisSize: MainAxisSize.min,
             children:  [
               Text("Are you sure you want to save and upload the pages to the patient's prescription?",
                   style: const TextStyle(fontWeight: FontWeight.w400, fontSize: 14)),
               const  SizedBox(height: 10),
             ],
           ),
