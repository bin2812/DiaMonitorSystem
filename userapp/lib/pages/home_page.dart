  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        ...
        body:_isLoading||_locationLoading?const ILoadingIndicatorWidget(): _selectedIndex == 1 ? const WalletPage() : _selectedIndex == 2
      ...
      if (!_doctorsController.isError.value) { // if no any error
        if (_doctorsController.isLoading.value) {
          ...
          return  Padding(
            ...
            child: Text("No Doctors found in $cityName!",
            style: TextStyle(
              fontSize: 15,
              fontWeight: FontWeight.w500
            ),
